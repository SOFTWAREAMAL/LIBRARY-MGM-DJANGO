...
#                 cursor.execute('DELETE FROM library_books where book_name = %s',[b_name])
#                 mysql.commit()
#                 return HttpResponse(f"<h1>Book is removed by Admin ! </h1>")
#         else:
#             messages.error(request, 'Invalid admin password')
...
# def al_message(request):
#     if request.method == "POST":
#         ad_name = request.POST.get("admin_name")
#         ad_pw = request.POST.get("admin_password")
#         if ad_name == 'admin' and ad_pw == '123':
#             messages.success(request, "Admin successfully Login ! Go to Home Page")
#         else:
#             # messages.error(request, 'Invalid username or password')
#             return render(request,'admin_login.html')
#     return render(request, 'al_message.html') 
...
#             else:
#                 return redirect("<h1> Invalid </h1>")
#                 # pass
#         else:
#             return render("<h1> Invalid </h1>")
#             # pass
#     return render(request, 'admin_login.html')  # Render login form
